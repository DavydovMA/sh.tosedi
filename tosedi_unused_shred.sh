...
SOFT_FILE="tosedi_unused_shred.sh"
SOFT_NAME="sh.tosedi_unused_shred"
SOFT_VERSION="20.01"
...
# sh.tosedi_unused_shred
# - скрипт, захламляет на диске GPT: неиспользуемое пространство.
